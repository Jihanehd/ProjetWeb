...
import './Dermatologie.css'; // ou tu peux réutiliser Chirugie.css si partagé
...
const handleSubmit = async (e) => {
  ...
  const doctors = ListMedecins.filter(doc => doc.speciality === "Dermatologie");

  const services = [
    "Consultations dermatologiques",
    "Traitements des allergies",
    "Soins esthétiques dermatologiques"
  ];

  return (
    <div className="specialite-page-Chirugie">
      <h1 className="main-title-Chirugie">Dermatologie</h1>
      <p className="description-Chirugie">
        La dermatologie traite les maladies de la peau, des cheveux et des ongles.
      </p>
      ...
      <section className="doctors-list-Chirugie">
        <h2 className="subtitle">Nos dermatologues</h2>
