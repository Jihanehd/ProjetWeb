...
import './MedGenerale.css'; // ou spécialite.css commun

const MedecineGenerale = () => {
...
const handleSubmit = async (e) => {
  ...
  const doctors = ListMedecins.filter(doc => doc.speciality === "Médecine générale");
  ...
  return (
    <div className="specialite-page-Chirugie">
      <h1 className="main-title-Chirugie">Médecine générale</h1>
      <p className="description-Chirugie">
        La médecine générale est la spécialité qui assure les soins médicaux de premier recours pour tous les âges.
      </p>
      ...
      <section className="doctors-list-Chirugie">
        <h2 className="subtitle">Nos médecins généralistes</h2>
...
export default MedecineGenerale;
