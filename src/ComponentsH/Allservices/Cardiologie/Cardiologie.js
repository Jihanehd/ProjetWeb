...
const handleSubmit = async (e) => {
  ...
  const doctors = ListMedecins.filter(doc => doc.speciality === "Cardiologie");
  ...
  return (
    <div className="specialite-page-Chirugie">
      <h1 className="main-title-Chirugie">Cardiologie</h1>
      <p className="description-Chirugie">
        La cardiologie est la spécialité médicale qui étudie et traite les maladies du cœur et des vaisseaux sanguins.
      </p>
      ...
      <section className="doctors-list-Chirugie">
        <h2 className="subtitle">Nos cardiologues</h2>
