...
import './Ortopedie.css'; // Ou specialite.css
...
const Orthopedie = () => {
  ...
  const doctors = ListMedecins.filter(doc => doc.speciality === "Orthopédie");
  ...
  return (
    <div className="specialite-page-Chirugie">
      <h1 className="main-title-Chirugie">Orthopédie</h1>
      <p className="description-Chirugie">
        L'orthopédie traite les maladies et traumatismes des os, des articulations et des muscles.
      </p>
      ...
      <section className="doctors-list-Chirugie">
        <h2 className="subtitle">Nos orthopédistes</h2>
