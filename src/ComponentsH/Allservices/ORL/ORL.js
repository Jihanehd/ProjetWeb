...
import './ORL.css'; // Ou "specialite.css" partagé
...
const handleSubmit = async (e) => {
  ...
  const doctors = ListMedecins.filter(doc => doc.speciality === "ORL");
  ...
  return (
    <div className="specialite-page-Chirugie">
      <h1 className="main-title-Chirugie">ORL</h1>
      <p className="description-Chirugie">
        L'ORL traite les maladies des oreilles, du nez et de la gorge.
      </p>
      ...
      <section className="doctors-list-Chirugie">
        <h2 className="subtitle">Nos spécialistes ORL</h2>
