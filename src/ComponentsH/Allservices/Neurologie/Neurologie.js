...
import './Neurologie.css'; // Ou `specialite.css` si centralisé
...
const Neurologie = () => {
  ...
  const doctors = ListMedecins.filter(doc => doc.speciality === "Neurologie");

  const services = [
    "Consultations neurologiques",
    "Électroencéphalogramme (EEG)",
    "Suivi des maladies neurodégénératives"
  ];

  return (
    <div className="specialite-page-Chirugie">
      <h1 className="main-title-Chirugie">Neurologie</h1>
      <p className="description-Chirugie">
        La neurologie traite les troubles du système nerveux, du cerveau et de la moelle épinière.
      </p>
      ...
      <section className="doctors-list-Chirugie">
        <h2 className="subtitle">Nos neurologues</h2>
