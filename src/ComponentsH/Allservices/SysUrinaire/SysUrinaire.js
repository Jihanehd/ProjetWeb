...
import './SysUrinaire.css'; // ou specialite.css si centralisé

const SystemeUrinaire = () => {
  ...
  const doctors = ListMedecins.filter(doc => doc.speciality === "Système urinaire");

  const services = [
    "Consultations urologiques",
    "Examens urinaires",
  ...
  return (
    <div className="specialite-page-Chirugie">
      <h1 className="main-title-Chirugie">Système urinaire</h1>
      <p className="description-Chirugie">
        La spécialité du système urinaire traite les maladies des reins, de la vessie et de l'appareil urinaire.
      </p>
      ...
      <section className="doctors-list-Chirugie">
        <h2 className="subtitle">Nos urologues</h2>
...
export default SystemeUrinaire;
