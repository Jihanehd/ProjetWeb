...
import './Pediatrie.css'; // Ou importer "specialite.css"
...
const handleSubmit = async (e) => {
  ...
  const doctors = ListMedecins.filter(doc => doc.speciality === "Pédiatrie");
  ...
  return (
    <div className="specialite-page-Chirugie">
      <h1 className="main-title-Chirugie">Pédiatrie</h1>
      <p className="description-Chirugie">
        La pédiatrie prend en charge la santé des nourrissons, des enfants et des adolescents.
      </p>
      ...
      <section className="doctors-list-Chirugie">
        <h2 className="subtitle">Nos pédiatres</h2>
