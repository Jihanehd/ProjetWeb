...
import './Gynecologie.css'; // tu peux aussi utiliser "specialite.css" partagé
...
const Gynecologie = () => {
  ...
  const doctors = ListMedecins.filter(doc => doc.speciality === "Gynécologie");
  ...
  return (
    <div className="specialite-page-Chirugie">
      <h1 className="main-title-Chirugie">Gynécologie</h1>
      <p className="description-Chirugie">
        La gynécologie traite la santé du système reproducteur féminin, du suivi de grossesse aux soins préventifs et chirurgicaux.
      </p>
      ...
      <section className="doctors-list-Chirugie">
        <h2 className="subtitle">Nos gynécologues</h2>
